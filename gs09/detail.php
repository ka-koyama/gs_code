    ...
    <form method="POST" action="update.php">
        <div class="form">
            <fieldset> <!--フォームをグループ化する→tabで次の入力キーに移れる-->
                <legend>内容を編集</legend> <!--グループ化したフォームにタイトルをつける-->
                <label><input type="text" name="name" value="<?=$row["name"]?>" class="textbox_1" placeholder="タイトルを入力"></label><br>
                <label><input type="text" name="author" value="<?=$row["author"]?>" class="textbox_1" placeholder="著者を入力"></label><br>
                ...
                <label><input type="text" name="url" value="<?=$row["url"]?>" class="textbox_1" placeholder="関連URLを入力"></label><br><br>
                <input type="submit" value="更新" class="btn_square_4">
